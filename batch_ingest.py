...
# create connection
connection = happybase.Connection('localhost', port=3306, autoconnect=False)
...
insert_data('yellow_tripdata_2017-03.csv', 'yellow_taxi')
insert_data('yellow_tripdata_2017-04.csv', 'yellow_taxi')