# Average trip revenue per month - analysing it by hour of the day (day vs night) and the day of the week (weekday vs weekend).

from mrjob.job import MRJob
from datetime import datetime

class AverageRevenueOverTimeAndDays(MRJob):
...
if __name__ == '__main__':
    AverageRevenueOverTimeAndDays.run()